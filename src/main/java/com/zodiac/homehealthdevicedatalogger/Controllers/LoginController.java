...
//	@FXML
//	public void handleLogin(ActionEvent mouseEvent) throws IOException, SQLException {
...
//
//		// Validate login
//		User user = validator.validateUser(email, password);
//
//		if (user != null) {
...
//				//technicianDashboardController.loadPatients();
//
//
...
//			// Assuming the server sends success message and user role
//			User user = new User(email, password); // You'll have to parse user details
...
//	}
//
//	// Method to handle server connection and login validation
//	private String loginToServer(String email, String password) {
//		try (Socket socket = new Socket("localhost" ,8100); // Change server IP if needed
...
//			return "SUCCESS"; // SERVER: SUCCESS/FAILURE
//		} catch (IOException e) {
//			e.printStackTrace();
